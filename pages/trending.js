...
export default function Trending({top_vendors}) { //NOTE: I IMPLEMENTED W/O API CALL, CAN MAKE ONE IF STILL NEEDED
  return (
    <div>
      <Head>
            ...
            {top_vendors.map((vendor) => (
			  ...
			  <div>
                ...
                <h3>{vendor.cuisine}</h3>
					{vendor.average_rating == -1 ? <h3>Rating pending</h3> : <h3> Rated {vendor.average_rating} Stars</h3>}
