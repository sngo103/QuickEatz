...
export default async function handler(req, res){ //IMPLEMENTATION POTENTIALLY SLOW, LOOK INTO LATER
  ...
  const rating = parseFloat(data.rating);
	  ...
	  const all_vendor_reviews = await db.collection("reviews").find(all_vendor_reviews_search).toArray();
